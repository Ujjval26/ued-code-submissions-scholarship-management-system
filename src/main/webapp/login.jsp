							...
							<div class="col-lg-6">
								<div class="card-body p-md-5 mx-md-4">
									...
									<form action="loginlogic.jsp" method="post">
										...
										<a href="forget_pass.jsp"><p class="mb-0 me-2 for"
												style="width: 150px; margin-top: 10px; color: #000; font-family: Arial;">Forgot
												Password?</p></a>
										...
										<div class="d-flex justify-content-center pb-4"
											...
											<p class="mb-0 me-2"
												style="margin-top: 10px; margin-left: -60px !important;">Don't
												have an account?</p>
